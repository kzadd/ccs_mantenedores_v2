...
type UserForm = FormControlsOf<User>
type UserKey = Extract<keyof User, string>
...
export class FormContainerComponent implements OnInit {
  ...
  form: FormGroup = this._formBuilder.group<UserForm>({
  ...
  handleSubmit(): void {
    ...
    if (this.form.valid) {
      ...
      this._router.navigate([FULL_ROUTE_PATHS.dashboard.user.root])
    } else {
