...
type CompanyForm = FormControlsOf<Company>
type CompanyKey = Extract<keyof Company, string>
...
export class FormContainerComponent implements OnInit {
  ...
  form: FormGroup = this._formBuilder.group<CompanyForm>({
  ...
  handleSubmit(): void {
    ...
    if (this.form.valid) {
      ...
      this._router.navigate([FULL_ROUTE_PATHS.dashboard.company.root])
    } else {
