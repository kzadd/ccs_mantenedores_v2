...
type DealershipForm = FormControlsOf<Dealership>
type DealershipKey = Extract<keyof Dealership, string>
...
export class FormContainerComponent implements OnInit {
  ...
  form: FormGroup = this._formBuilder.group<DealershipForm>({
  ...
  handleSubmit(): void {
    ...
    if (this.form.valid) {
      ...
      this._router.navigate([FULL_ROUTE_PATHS.dashboard.dealership.root])
    } else {
