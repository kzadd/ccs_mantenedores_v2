...
type MenuForm = FormControlsOf<Menu>
type MenuKey = Extract<keyof Menu, string>
...
export class FormContainerComponent implements OnInit {
  ...
  form: FormGroup = this._formBuilder.group<MenuForm>({
  ...
  getErrorMessage(controlName: MenuKey): string {
  ...
  handleSubmit(): void {
    ...
    if (this.form.valid) {
      ...
      this._router.navigate([FULL_ROUTE_PATHS.dashboard.menu.root])
    } else {
