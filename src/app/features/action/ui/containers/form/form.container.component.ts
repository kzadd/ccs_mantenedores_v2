...
type ActionForm = FormControlsOf<Action>
type ActionKey = Extract<keyof Action, string>
...
export class FormContainerComponent implements OnInit {
  ...
  form: FormGroup = this._formBuilder.group<ActionForm>({
  ...
  getErrorMessage(controlName: ActionKey): string {
  ...
  handleSubmit(): void {
    ...
    if (this.form.valid) {
      ...
      this._router.navigate([FULL_ROUTE_PATHS.dashboard.action.root])
    } else {
