...
type FunctionalityForm = FormControlsOf<Functionality>
type FunctionalityKey = Extract<keyof Functionality, string>
...
export class FormContainerComponent implements OnInit {
  ...
  form: FormGroup = this._formBuilder.group<FunctionalityForm>({
  ...
  handleSubmit(): void {
    ...
    if (this.form.valid) {
      ...
      this._router.navigate([FULL_ROUTE_PATHS.dashboard.functionality.root])
    } else {
