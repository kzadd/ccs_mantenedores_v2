...
type RoleForm = FormControlsOf<Role>
type RoleKey = Extract<keyof Role, string>
...
export class FormContainerComponent implements OnInit {
  ...
  form: FormGroup = this._formBuilder.group<RoleForm>({
  ...
  handleSubmit(): void {
    ...
    if (this.form.valid) {
      ...
      this._router.navigate([FULL_ROUTE_PATHS.dashboard.role.root])
    } else {
